...
- **[mjmcgowan17/entity-relation-schema](https://github.com/mjmcgowan17/claude-quickstarts/tree/main/agents/tools/entity_store.py)** - In-memory entity-relation graph store for agent knowledge tracking
